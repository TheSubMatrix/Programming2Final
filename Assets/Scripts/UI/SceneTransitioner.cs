...
public class SceneTransitioner : MonoBehaviour
{
    ...
    {
        StartCoroutine(FadeCanvasGroup(1, 0.5f, sceneToTransitionTo));
    }
    IEnumerator FadeCanvasGroup(float desiredOpacity, float desiredTime, string sceneToTransitionTo = null)
    {
